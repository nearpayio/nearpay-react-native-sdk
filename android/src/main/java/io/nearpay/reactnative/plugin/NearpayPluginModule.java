...
public class NearpayPluginModule extends ReactContextBaseJavaModule {
  ...
  // private CompletableFuture<Map> preCallFunction(Map args, Promise
  // reactPromise) {
  // CompletableFuture<Map> promise = new CompletableFuture<>();
  // provider.getArgsFilter().filter(args);
  //
  // promise.thenAccept(res -> reactPromise.resolve(res));
  //
  // return promise;
  // }
  ...
  public void initialize(ReadableMap params, Promise reactPromise) {
    ...
    // Map args = NearPayUtil.toMap(params);
    // CompletableFuture<Map> promise = preCallFunction(args, reactPromise);
    // BaseOperation operation = new InitializeOperation(provider);
    // operation.run(args, promise);
    ...
    // } else {
    // this.nearPay = new NearPay(this.context, getAuthType(authType, authValue),
    // locale, env);
  ...
  public void purchase(ReadableMap params, Promise reactPromise) {
    ...
    // Map<String, Object> paramMap =
    // commonResponse(ErrorStatus.initialise_failed_code,
  ...
  // options.optString("customer_reference_number", "");
  ...
  // doPurchase(amount, customer_reference_number, isEnableUI, isEnableReverse,
  // timeout, authType, authValue, promise);

  // }

  // }

  // public void doPurchase(Long amount, String customerReferenceNumber, Boolean
  // enableReceiptUi, Boolean isEnableReverse,
  // Long finishTimeOut, String authType, String authValue, Promise promise) {
  // this.nearPay.purchase(amount, customerReferenceNumber, enableReceiptUi,
  // isEnableReverse, finishTimeOut,
  ...
  // Map<String, Object> paramMap =
  // commonResponse(ErrorStatus.general_failure_code,
  ...
  // Map<String, Object> paramMap =
  // commonResponse(ErrorStatus.purchase_declined_code, message);
  // promise.resolve(toJson(paramMap));
  ...
  // Map<String, Object> paramMap =
  // commonResponse(ErrorStatus.purchase_rejected_code, message);
  // promise.resolve(toJson(paramMap));
  ...
  // }
  // Map<String, Object> paramMap = commonResponse(ErrorStatus.auth_failed_code,
  // message);
  // promise.resolve(toJson(paramMap));
  ...
  // Map<String, Object> paramMap = commonResponse(ErrorStatus.invalid_code,
  // message);
  // promise.resolve(toJson(paramMap));
  // }
  // }
  ...
  // String authType = options.optString("authtype", this.authTypeShared);
  // Boolean isEnableReverse = options.optBoolean("isEnableReversal", true);
  // Boolean isEditableReversalUI = options.optBoolean("isEditableReversalUI",
  // true);
  ...
  // isEnableUI, isEnableReverse,
  // isEditableReversalUI, authType, authValue, timeout, adminPin, promise);
  // }
  ...
  // Boolean enableReceiptUi, Boolean isEnableReverse, Boolean
  // isEditableReversalUI, String authType, String authValue,
  // Long finishTimeOut, String adminPin, Promise promise) {
  // nearPay.refund(amount, transactionReferenceRetrievalNumber,
  // customerReferenceNumber, enableReceiptUi,
  // isEnableReverse, isEditableReversalUI, finishTimeOut, adminPin, new
  // RefundListener() {
  // @Override
  ...
  // Map<String, Object> paramMap =
  // commonResponse(ErrorStatus.refund_declined_code, message);
  // promise.resolve(toJson(paramMap));
  ...
  // Map<String, Object> paramMap =
  // commonResponse(ErrorStatus.refund_rejected_code, message);
  // promise.resolve(toJson(paramMap));
  ...
  // private static Map<String, Object> commonResponse(int responseCode, String
  // message) {
  ...
  // getTransactionGetResponse(TransactionReceipt transactionReceipt, String
  // message) {
  ...
  // paramMap.put("system_trace_audit_number",
  // transactionReceipt.getSystem_trace_audit_number());
  // paramMap.put("pos_software_version_number",
  // transactionReceipt.getPos_software_version_number());
  // paramMap.put("retrieval_reference_number",
  // transactionReceipt.getRetrieval_reference_number());
  ...
  // transactionReceipt.getVerification_method();
  ...
  // recipentInlineone.put("arabic",
  // transactionReceipt.getReceipt_line_one().getArabic());
  // recipentInlineone.put("english",
  // transactionReceipt.getReceipt_line_one().getEnglish());
  // paramMap.put("receipt_line_one", recipentInlineone);

  // // Recipent Inline one
  // Map<String, Object> recipentInlineTwo = new HashMap<>();
  // recipentInlineTwo.put("arabic",
  // transactionReceipt.getReceipt_line_two().getArabic());
  // recipentInlineTwo.put("english",
  // transactionReceipt.getReceipt_line_two().getEnglish());
  // paramMap.put("receipt_line_two", recipentInlineTwo);

  // // Recipent Thanks Message
  // Map<String, Object> thanksMessage = new HashMap<>();
  // thanksMessage.put("arabic",
  // transactionReceipt.getThanks_message().getArabic());
  // thanksMessage.put("english",
  // transactionReceipt.getThanks_message().getEnglish());
  // paramMap.put("thanks_message", thanksMessage);

  // // Recipent Save Message
  // Map<String, Object> saveMessage = new HashMap<>();
  // saveMessage.put("arabic",
  // transactionReceipt.getSave_receipt_message().getArabic());
  // saveMessage.put("english",
  // transactionReceipt.getSave_receipt_message().getEnglish());
  ...
  // paramMap.put("terminal_verification_result",
  // transactionReceipt.getTerminal_verification_result());
  // paramMap.put("application_identifier",
  // transactionReceipt.getApplication_identifier());
  // paramMap.put("transaction_state_information",
  // transactionReceipt.getTransaction_state_information());
  // paramMap.put("cardholader_verfication_result",
  // transactionReceipt.getCardholader_verfication_result());
  // paramMap.put("cryptogram_information_data",
  // transactionReceipt.getCryptogram_information_data());
  // paramMap.put("application_cryptogram",
  // transactionReceipt.getApplication_cryptogram());
  // paramMap.put("kernel_id", transactionReceipt.getKernel_id());
  // paramMap.put("payment_account_reference",
  // transactionReceipt.getPayment_account_reference());
  ...
  // String adminPin, Promise promise) {
  // Log.i("doReconcile....", "doReconcile.......first....");
  // nearPay.reconcile(enableReceiptUi, adminPin, finishTimeOut, new
  // ReconcileListener() {
  // @Override
  ...
  // private static Map<String, Object> reconcileGetResponse(ReconciliationReceipt
  // reconcileReceipt, String message) {
  // Map<String, Object> paramMap = new HashMap<>();
  ...
  // } else if (index == 1) {
  // Map<String, Object> creditDict =
  // reconcileCommon(element.getPos().getCredit());
  ...
  // } else if (index == 2) {
  // Map<String, Object> hostcreditDict =
  // reconcileCommon(element.getHost().getCredit());
  // Map<String, Object> hostdebitDict =
  // reconcileCommon(element.getHost().getDebit());
  // Map<String, Object> hosttotalDict =
  // reconcileCommon(element.getHost().getTotal());
  // Map<String, Object> finalDict = new HashMap<>();
  ...
  // private static Map<String, Object> reconcileCommon(ReconciliationLabelField
  // data) {
  ...
  // Long timeout, Promise promise) {
  // Log.i("doReverseAction....", "doReverseAction.......first....");
  // Long finishTimeOut = Long.valueOf(timeout);

  // nearPay.reverse(transactionUuid, enableReceiptUi, finishTimeOut, new
  // ReversalListener() {
  ...
  private void logout(ReadableMap params, Promise reactPromise) {
    ...
    // Map<String, Object> paramMap =
    // commonResponse(ErrorStatus.logout_already_code, "User already logout");
    // promise.resolve(toJson(paramMap));
  ...
  // Map<String, Object> paramMap =
  // commonResponse(ErrorStatus.already_installed_code,
  ...
  // Promise promise) {
  // nearPay.session(sessionID, enableReceiptUi, enableReversal, finishTimeOut,
  // new SessionListener() {
  // @Override
