...
import { ReconcileFailureMessage, ReconcileAuthenticationFailed, ReconcileInvalidStatus, ReconcileGeneralFailure } from './reconcile_error';

export function getReconcileError(nativeResponse: { status: number; [key: string]: any }) {
